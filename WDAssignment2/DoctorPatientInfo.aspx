<%--*****************************************************************
    * DoctorPatientInfo.aspx                             v1.0 11/2014
...
<%@ Page Title="" Language="C#" 
    ...
    CodeBehind="DoctorPatientInfo.aspx.cs" Inherits="WDAssignment2.DoctorPatientInfo" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <p>
        ...
        <asp:panel ID="DoctorInfoPanel" runat="server" Visible="false">
            ...
            <%-- Validate text entered --%>
            <asp:RequiredFieldValidator ID="DoctorIdRequiredValidator1" runat="server" ForeColor="#B6121B" Width="100"
                                        ErrorMessage="Doctor ID Required" ControlToValidate="DoctorId1" Display="dynamic"/>
            <%-- Validate string is of form "111" (at least 1 number, max 3) --%>
            <asp:RegularExpressionValidator ID="DoctorRegexValidator1" runat="server" ForeColor="#B6121B" Width="100"
                                            ErrorMessage="Input Incorrect. Numbers only, 3 Numbers Max." ControlToValidate="DoctorId1"
                                            ValidationExpression="^[1-9]{1,3}$" Display="Dynamic" />
            <%-- Validate provided doctor ID exists in database --%>
            <asp:CustomValidator ID="DoctorIdValidator1" runat="server" ForeColor="#B6121B" Width="100"
